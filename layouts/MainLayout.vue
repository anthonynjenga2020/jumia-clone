        ...
        <div
            ...
            <ul
                class="
                    ...
                    max-w-[1200px]"
                    >
                    <li class="border-r border-r-gray-400 px-3 hover:text-[#FF4646] cursor-pointer">Sell on Jumia</li>
                    ...
                    >
                       ...
                       <div
                        ...
                        <div v-if="true">
                            <div class="text-semibold text-[15px] my-4 px-3">Welcome to Jumia!</div>
                        ...
                        <ul class="bg-white">
                            <li
                                ...
                                class="text-[13px] py-2 px-4 w-full hover:bg-gray-200">My Orders
                            </li>
                            <li
                                v-if="true"
                                class="text-[13px] py-2 px-4 w-full hover:bg-gray-200">Sign out</li>
                        </ul>
                    </div>
        ...
        <div 
            ...
            <div class="flex lg:justify-start justify-between gap-10 max-w-[1150px] w-full px-3 mx-auto">
                <NuxtLink to="/" class="min-w-[170px]">
                    <img width="170" src="/public/AliExpress-logo.png" alt="">
                </NuxtLink>
                ...
                <div class="max-w-[700px] w-full md:block hidden">
                    <div class="relative">
                        ...
                        <div class="absolute bg-white max-w-[700px] h-auto w-full">
                            <div v-if="false" class="p1">
                                <NuxtLink
                                    to="`/item/1`"
                                    class="flex items-center justify-between w-full cursor-pointer hover:bg-gray-100">
                                <div class="flex items-center">
                                    <img class="rounded-md" width="40" src="">
